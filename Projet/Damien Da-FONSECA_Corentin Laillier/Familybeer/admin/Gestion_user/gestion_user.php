    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" href="gestion_user.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">people</i>Gestion des Utilisateus</a>
          <div class="mdl-layout-spacer"></div>
...
<!-- Début d'un tableau pour lister les élements-->
        <div class="container admin">
            <div class="row">
                <h1><strong>Liste des users   </strong></h1>
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                      ...
                      // Select de tout les éléments de informations
                        $statement = $db->query('SELECT * FROM informations');
