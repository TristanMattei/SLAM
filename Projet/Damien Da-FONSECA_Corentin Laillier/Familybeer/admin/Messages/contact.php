    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" href="contact.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">forum</i>Messages</a>
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    // include de la connexion a la base de donnée
                      ...
                      // Select de tout les éléments de contact
                      ...
                      while($item = $statement->fetch())
                      {
                          ...
                          echo '<td>'. $item['num_telephone'] . '</td>';
                          echo '<td>'. $item['message'] . '</td>';
                          echo '<td>'. $item['date_contact'] . '</td>';
                          echo '<td width=300>';
                          echo ' ';
