    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" href="../Menus/gestion_menu.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">inbox</i>Gestion des Menus</a>
          ...
          <a class="mdl-navigation__link" href="commandes_user.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">shopping_cart</i>Reservations</a>
...
<!-- Début d'un tableau pour lister les élements-->
            ...
            <div class="row">
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                      ...
                      // Select de tout les éléments de reservations
                        $statement = $db->query('SELECT * FROM reservations');

                      // Boucle pour lister les éléments de la table
                        while($item = $statement->fetch())
                        {
                            echo '<tr>';
                            echo '<td>'. $item['nom'] . '</td>';
                            echo '<td>'. $item['mail'] . '</td>';
                            echo '<td>'. $item['personne'] . '</td>';
                            echo '<td>'. $item['date_res'] . '</td>';
