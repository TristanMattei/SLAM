...
<header class="fixed-top">
        <div class="container">
                ...
                <div class="right-area">
                        <h6><a class="plr-5 color-white btn-fill-primary">Commandes: +33 1 23 12 19 99</a></h6>
                </div><!-- right-area -->
...
<section class="story-area left-text center-sm-text pos-relative">
        ...
        <div class="container">
                ...
                <form class="form-horizontal" action="inscription.php">
      <div class="form-group">
        <label class="control-label col-sm-2" for="nom">Nom:</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" id="nom" placeholder="Sun" name="nom" required="">
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-sm-2" for="prenom">Prénom:</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" id="prenom" placeholder="Rei" name="prenom" required="">
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-sm-2" for="psswd">Mot de passe:</label>
        <div class="col-sm-10">
          <input type="password" class="form-control" id="psswd" placeholder="Ralsei023" name="psswd" required="">
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-sm-2" for="birth">Date de naissance:</label>
        <div class="col-sm-10">
          <input type="date" class="form-control" id="birth" placeholder="1999-12-25" max="2002-12-31" name="birth" required="">
        </div>
      </div>
      <div class="form-group">
        <label class="control-label col-sm-2" for="postal">Adresse postale:</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" id="postal" placeholder="Nowhere" name="postal" required="">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="tel" class="form-control" id="phone" placeholder="06" name="phone" pattern="[0-9]{10}"
       required>
        </div>
      </div>
      <div class="form-group">        
...
$req = $bdd->prepare("INSERT INTO 'users'('email', 'prenom', 'nom', 'psswd', 'phone', 'birthday', 'postal', 'role') VALUES (:email,:prenom,:nom,:psswd,:phone,:birth,:postal,:role);");
        $req->execute (array(
    'email'=>$email,
    'prenom'=>$prenom,
    'nom'=>$nom,
